...
author: "<br>Juliet R.C. Pulliam &amp; Carl A.B. Pearson, 2016-2024<br>Some rights reserved<br><br><a href='http://creativecommons.org/licenses/by-nc/4.0/'>CC BY-NC 4.0</a>"
output:
  html_document:
    theme: spacelab
    code_folding: hide
...
setDelta <- 0.1
setBoxes <- 4
model_display <- function(fun) {
  cat("```r\n")
  cat(substitute(fun), "<- ")
  cat(deparse(fun, control = "all"), sep="\n")
  cat("```\n")
}
```
