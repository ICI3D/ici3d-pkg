...
The basic model structure is shown in the diagram to the right. You can view/hide the code used to produce the plot or specify the model by toggling the associated **Code** button.
